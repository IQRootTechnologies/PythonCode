...
imbody = PIL.Image.open('/home/emertxe/assign/CastScreen-master/receiver/river.jpg')

tkimbody= ImageTk.PhotoImage(imbody)
global cvsbody
cvsbody=Canvas(root,width=1280,height=720,border=0,highlightthickness=0)
cvsbody.pack()
...
global dtimer_t
dtimer_t=threading.Timer(8,display_start_timer)
